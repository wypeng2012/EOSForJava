package party.loveit.eosforandroidlibrary.utils;
...
//				.putLong(Long.parseLong(amount));
	...
	public static byte[] writerKey(String key) {
		party.loveit.eosforandroidlibrary.utils.ByteBuffer  bf = new party.loveit.eosforandroidlibrary.utils.ByteBuffer ();
